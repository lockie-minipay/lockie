const Carrot = () => {
  return (
    <svg
      ...
      viewBox="0 0 256 256"
      focusable="false"
      color='var(--token-2dee5c4a-ec61-47f9-818b-fddca6a7763b, rgb(34, 34, 34)) /* {"name":"Primary"} */'
    >
      <g color='var(--token-2dee5c4a-ec61-47f9-818b-fddca6a7763b, rgb(34, 34, 34)) /* {"name":"Primary"} */'>
