...
async function main() {
  ...
  const lockieContract = new ethers.Contract(
    lockieAddress,
    [
      {
        anonymous: false,
  ...
  const cusdAddress = "0x8d9EAc6f25470EFfD68f0AD22993CB2813c0c9B9";
  const depositFilter = lockieContract.filters.Deposit(
    cusdAddress,
    null,
    userAddress,
    null,
  ...
  const withdrawFilter = lockieContract.filters.Withdraw(
    cusdAddress,
    null,
    userAddress,
    null
  ...
  for (let i = 0; i < withdrawEvents.length; i++) {
    ...
    //console.log(depositEvents[i]);
  }

  //console.log(totalWithdrawals.toString());
